...
hoepfully with a few modifications
"""
...
## make the frozen lake environment
env = gym.make(
    "FrozenLake-v1",
...
## setting up Q-learning and epsilon greedy classes
...
## define environment running and post-processing functions
def run_env():
